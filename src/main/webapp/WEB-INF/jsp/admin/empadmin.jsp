...
<img src="../../../resources/images/top.jpg" width="1002" height="258" style="position: absolute;left: 0px"/></div>
<!-- #EndLibraryItem -->
    ...
    <tr>
        <td class="rightimg"><!-- #BeginLibraryItem "/Library/left3.lbi" -->
            ...
            <div id="right">
                ...
                <form id="form1" name="form1" method="post" action="/admin/empadmin/del">
